...
% Last Modified by GUIDE v2.5 26-Feb-2020 10:36:08
...
D=num2str(D); set(handles.D_edit, 'string', D);
x1=num2str(x1); set(handles.x1_edit, 'string', x1);
x2=num2str(x2); set(handles.x2_edit, 'string', x2);
...
title(['Plot of: ' num2str(a) 'x^2 + ' num2str(b) 'x + ' num2str(c) ' = 0']);
grid on
